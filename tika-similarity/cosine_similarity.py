...
def filterFiles(inputDir, acceptTypes):
    ...
    print "filename_list size ", len(filename_list)
...
#             print "data"
#             print file1_parsedData["metadata"]
#             print "features"
#             print v1.features

            if v1.getMagnitude() == 0 or v2.getMagnitude() == 0:
                continue
            ...
            count += 1
            if (count % 1000 == 0):
                print count , " tuples processed"
            
        
        print "tuple size " , count
